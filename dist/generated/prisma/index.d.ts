...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "name" | "lastName" | "firstName" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type SimulationGroupByOutputType = {
    ...
    charges: JsonValue
    mortgage: JsonValue
    taxProfile: JsonValue
    rentability: JsonValue | null
    userId: number
    _count: SimulationCountAggregateOutputType | null
    _avg: SimulationAvgAggregateOutputType | null
    _sum: SimulationSumAggregateOutputType | null
  ...
  export type SimulationOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "createdAt" | "updatedAt" | "property" | "charges" | "mortgage" | "taxProfile" | "rentability" | "userId", ExtArgs["result"]["simulation"]>
  ...
  export type $SimulationPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    scalars: $Extensions.GetPayloadResult<{
      ...
      mortgage: Prisma.JsonValue
      taxProfile: Prisma.JsonValue
      rentability: Prisma.JsonValue | null
      userId: number
    }, ExtArgs["result"]["simulation"]>
    composites: {}
  }
  ...
  interface SimulationFieldRefs {
    ...
    readonly property: FieldRef<"Simulation", 'Json'>
    readonly charges: FieldRef<"Simulation", 'Json'>
    readonly mortgage: FieldRef<"Simulation", 'Json'>
    readonly taxProfile: FieldRef<"Simulation", 'Json'>
    readonly rentability: FieldRef<"Simulation", 'Json'>
  ...
  export const SimulationOrderByRelevanceFieldEnum: {
    id: 'id',
    name: 'name'
  };

  export type SimulationOrderByRelevanceFieldEnum = (typeof SimulationOrderByRelevanceFieldEnum)[keyof typeof SimulationOrderByRelevanceFieldEnum]
  ...
  export type SimulationWhereInput = {
    ...
    property?: JsonFilter<"Simulation">
    charges?: JsonFilter<"Simulation">
    mortgage?: JsonFilter<"Simulation">
    taxProfile?: JsonFilter<"Simulation">
    rentability?: JsonNullableFilter<"Simulation">
  ...
  export type SimulationOrderByWithRelationInput = {
    ...
    rentability?: SortOrderInput | SortOrder
    userId?: SortOrder
    user?: UserOrderByWithRelationInput
    _relevance?: SimulationOrderByRelevanceInput
  }
  ...
  export type SimulationScalarWhereWithAggregatesInput = {
    ...
    property?: JsonWithAggregatesFilter<"Simulation">
    charges?: JsonWithAggregatesFilter<"Simulation">
    mortgage?: JsonWithAggregatesFilter<"Simulation">
    taxProfile?: JsonWithAggregatesFilter<"Simulation">
    rentability?: JsonNullableWithAggregatesFilter<"Simulation">
  ...
  export type SimulationCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    property: JsonNullValueInput | InputJsonValue
    charges: JsonNullValueInput | InputJsonValue
    mortgage: JsonNullValueInput | InputJsonValue
    taxProfile: JsonNullValueInput | InputJsonValue
    rentability?: NullableJsonNullValueInput | InputJsonValue
  ...
  export type SimulationOrderByRelevanceInput = {
    fields: SimulationOrderByRelevanceFieldEnum | SimulationOrderByRelevanceFieldEnum[]
    sort: SortOrder
    search: string
  }
